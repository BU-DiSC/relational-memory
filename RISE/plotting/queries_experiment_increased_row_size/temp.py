...
#    ax.bar(x + -1*width,  np.divide(values['v4']['d']['h']['avg'], values['v4']['d']['c']['avg']), width, yerr=np.divide(values['v4']['d']['h']['std'], values['v4']['d']['c']['avg']), label="Direct Access")
    ax.plot([0, len(labels)-1], [1.0, 1.0], label="Direct Access", color="red")
    #ax.errorbar(x,  np.divide(values['v4']['d']['h']['avg'], values['v4']['d']['c']['avg']), yerr=np.divide(values['v4']['d']['h']['std'], values['v4']['d']['c']['avg']), label="MLP Cold", ecolor='black', capsize=2, marker=marks[0])
    #ax.errorbar(x,  np.divide(values['v4']['r']['c']['avg'], values['v4']['d']['c']['avg']), yerr=np.divide(values['v4']['r']['c']['std'], values['v4']['d']['c']['avg']), label="MLP Cold", ecolor='black', capsize=2, marker=marks[1])
    #ax.errorbar(x,  np.divide(values['v4']['r']['h']['avg'], values['v4']['d']['c']['avg']), yerr=np.divide(values['v4']['r']['h']['std'], values['v4']['d']['c']['avg']), label="MLP Hot", ecolor='black', capsize=2, marker=marks[2])
    ax.bar(x + -0.5*width,  np.divide(values['v4']['r']['c']['avg'], values['v4']['d']['c']['avg']), width, yerr=np.divide(values['v4']['r']['c']['std'], values['v4']['d']['c']['avg']), label="RME cold")
    ax.bar(x +  0.5*width,  np.divide(values['v4']['r']['h']['avg'], values['v4']['d']['c']['avg']), width, yerr=np.divide(values['v4']['r']['h']['std'], values['v4']['d']['c']['avg']), label="RME Hot")
...
if (__name__ == '__main__'):
    generate_plot(2, [4, 8, 12], (3.5, 2.5), 2)
    generate_plot(3, [4, 8, 12], (3.5, 2.5), 2)
    generate_plot(5, [4, 8, 12], (4.5, 2), 3)
    generate_plot(6, [4, 8, 12], (4.5, 2), 3)
    generate_plot(7, [4, 8, 12], (4.5, 2), 3)
    generate_plot(8, [4, 8, 12], (3.5, 2.5), 2)
